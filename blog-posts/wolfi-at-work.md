...
![Image of excited dog with caption: did someone say dogfood?](wolfi-at-work-1.jpeg)

We started by building on top of Google's [Cloud Workstations](https://cloud.google.com/workstations) product, which lets users specify a container image, which it then manages along with the underlying resources. Cloud Workstations also lets users specify a timeout after which it will stop the workstation, which is great for enforcing ephemerality and as a cost-saving measure.
...
![Bar graph comparing base image size: standard base over 1690 MB and Wolfi base at 780 MB.](wolfi-at-work-2.png)
...
![Gif meme with title: Brent Rambo, just another happy Wolfstation user.](wolfi-at-work-3.gif)
