...
![An image of old suitcases stacked on top of each other.](image-tagging-philosophy-pt1-1.jpeg)
...
You can observe changes to the official Go image over time. I've set up a [GitHub repo](https://github.com/imjasonh/image-scraper/) that periodically collects the current digest of certain tagged images, and you can see [changes](https://github.com/imjasonh/image-scraper/commits/main/index.docker.io/library/golang:1.21.1) to the `golang:1.21.1`tag there.
